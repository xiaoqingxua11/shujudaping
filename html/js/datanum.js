		...
		initHtml: function(obj, options) {
			...
			if (obj.find('.' + options.className).length <= 0) {
				for (var i = 0; i < valLen; i++) {
					if (nameDeVal[i] == ",") {
						strHtml +=
							'<li class="dataOne dataLine" style="width:30px;background:none;font-size:69px;"><div class="dataBoc"><div class="tt" t="38" style="font-family:\'微软雅黑\';"><em style="color:#fff5a1;font-family: "微软雅黑";" class="num0">,</em></div></div></li>';
					}
					if (nameDeVal[i] == ".") {
						strHtml +=
							'<li class="dataOne dataLine" style="width:30px;background:none;font-size:69px;"><div class="dataBoc"><div class="tt" t="38" style="font-family:\'微软雅黑\';"><em style="color:#fff5a1;font-family: "微软雅黑";" class="num0">.</em></div></div></li>';
